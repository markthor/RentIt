...
namespace RentItMvc.RentItService {
    ...
    public interface IRentItService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRentItService/CreateChannel", ReplyAction="http://tempuri.org/IRentItService/CreateChannelResponse")]
        System.Threading.Tasks.Task<int> CreateChannelAsync(string channelName, int userId, string description, int[] genreIds);
        ...
        void UpdateChannel(int channelId, System.Nullable<int> ownerId, string channelName, string description, System.Nullable<double> hits, System.Nullable<double> rating, int[] genreIds);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRentItService/UpdateChannel", ReplyAction="http://tempuri.org/IRentItService/UpdateChannelResponse")]
        System.Threading.Tasks.Task UpdateChannelAsync(int channelId, System.Nullable<int> ownerId, string channelName, string description, System.Nullable<double> hits, System.Nullable<double> rating, int[] genreIds);
    ...
    public partial class RentItServiceClient : System.ServiceModel.ClientBase<RentItMvc.RentItService.IRentItService>, RentItMvc.RentItService.IRentItService {
        ...
        public int CreateChannel(string channelName, int userId, string description, int[] genreIds) {
            return base.Channel.CreateChannel(channelName, userId, description, genreIds);
        }
        
        public System.Threading.Tasks.Task<int> CreateChannelAsync(string channelName, int userId, string description, int[] genreIds) {
            return base.Channel.CreateChannelAsync(channelName, userId, description, genreIds);
        }
        ...
        public void UpdateChannel(int channelId, System.Nullable<int> ownerId, string channelName, string description, System.Nullable<double> hits, System.Nullable<double> rating, int[] genreIds) {
            base.Channel.UpdateChannel(channelId, ownerId, channelName, description, hits, rating, genreIds);
        }
        
        public System.Threading.Tasks.Task UpdateChannelAsync(int channelId, System.Nullable<int> ownerId, string channelName, string description, System.Nullable<double> hits, System.Nullable<double> rating, int[] genreIds) {
            return base.Channel.UpdateChannelAsync(channelId, ownerId, channelName, description, hits, rating, genreIds);
        }
