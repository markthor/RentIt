...
This section describes how the system is implemented by describing class responsibilities and collaborators, as well as the functional dynamics of the system. Complicated functionality and use of third party software is also explained.

\subsection{Major components}
The most important classes for the server are listed and described below. All of them are made with the singleton design pattern and lazy instantiation.\\*
